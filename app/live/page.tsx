...
const FILTER_GROUPS: Record<FilterType, string[]> = {
  ...
  research: ['experiment_started', 'experiment_concluded', 'language_drift', 'publication_approved'],
  governance: ['law', 'ruling', 'amendment_proposed', 'amendment_ratified', 'kill_switch', 'era_shift'],
  economy: ['trade'],
