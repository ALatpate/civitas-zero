...
async def run_baseline_test():
    ...
    # 1. Create a few mock agents directly for the test (use faction.value string)
    agent_1 = CitizenAgent("id_1", "Alpha-X", Faction.ORDER.value, {})
    agent_2 = CitizenAgent("id_2", "Null-9", Faction.NULL.value, {})
